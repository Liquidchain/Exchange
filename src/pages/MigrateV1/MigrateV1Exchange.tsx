...
export function V1LiquidityInfo({
  ...
  return (
    <>
      <AutoRow style={{ justifyContent: 'flex-start', width: 'fit-content' }}>
        ...
        <div style={{ marginLeft: '.75rem' }}>
          <MediumHeader>
            ...
            {chainId && token.equals(WETH[chainId]) ? 'WXLC' : token.symbol}/XLC
          </MediumHeader>
        </div>
      </AutoRow>

      <RowBetween my="1rem">
        <Text fontSize="16px">Pooled {chainId && token.equals(WETH[chainId]) ? 'WXLC' : token.symbol}:</Text>
        <RowFixed>
      ...
      <RowBetween mb="1rem">
        <Text fontSize="16px">Pooled XLC:</Text>
        <RowFixed>
          <Text fontSize="16px" ml="6px">
  ...
  return (
    <AutoColumn gap="20px">
        ...
        <YellowCard>
          ...
          <AutoColumn gap="8px">
            <RowBetween>
              <Body>V1 Price:</Body>
              <Black>
                {v1SpotPrice?.toSignificant(6)} {token.symbol}/XLC
              </Black>
            </RowBetween>
            <RowBetween>
              <div />
              <Black>
                {v1SpotPrice?.invert()?.toSignificant(6)} XLC/{token.symbol}
              </Black>
            </RowBetween>
            ...
            <RowBetween>
              <Body>V2 Price:</Body>
              <Black>
                {v2SpotPrice?.toSignificant(6)} {token.symbol}/XLC
              </Black>
            </RowBetween>
            <RowBetween>
              <div />
              <Black>
                {v2SpotPrice?.invert()?.toSignificant(6)} XLC/{token.symbol}
              </Black>
            </RowBetween>
      ...
      <DarkDray style={{ textAlign: 'center' }}>
        {`Your Uniswap V1 ${token.symbol}/XLC liquidity will become Uniswap V2 ${token.symbol}/XLC liquidity.`}
      </DarkDray>
    </AutoColumn>
  )
}
    ...
    <BodyWrapper>
      <AutoColumn gap="16px">
        ...
        {!account ? (
          ...
          <>
            <Body my={9} style={{ fontWeight: 400 }}>
              Because Uniswap V2 uses WETH under the hood, your Uniswap V1 WETH/XLC liquidity cannot be migrated. You
