    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        addTransaction(response, {
          summary: `Remove ${chainId && token.equals(WETH[chainId]) ? 'WXLC' : token.symbol}/XLC V1 liquidity`,
        })
  ...
  return (
    <AutoColumn gap="20px">
      ...
      <DarkGray style={{ textAlign: 'center' }}>
        {`Your Uniswap V1 ${
          chainId && token.equals(WETH[chainId]) ? 'WXLC' : token.symbol
        }/XLC liquidity will be redeemed for underlying assets.`}
      </DarkGray>
    </AutoColumn>
  )
}
