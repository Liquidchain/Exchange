        ...
        <UpperSection>
          ...
          <ContentWrapper>
            {error instanceof UnsupportedChainIdError ? (
              <h5>
                Please connect to the appropriate Liquidchain network.
                <a href="https://docs.liquidchain.net/connect-to-metamask">How?</a>
              </h5>
            ) : (
    ...
    return (
      <UpperSection>
        ...
        <ContentWrapper>
          ...
          {walletView !== WALLET_VIEWS.PENDING && (
            <Blurb>
              <span>New to Liquidchain? &nbsp;</span>{' '}
              <ExternalLink href="https://docs.liquidchain.net/">
